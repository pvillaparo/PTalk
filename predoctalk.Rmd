...
## ¿Qué diferencia un Predoc de un RAship estándar? (1/2)

- **RAship estándar (para postulantes internacionales) significa:**
...
## ¿Qué diferencia un Predoc de un RAship estándar? (2/2)

- **El Predoc es un RAship institucionalizado es una señalización más robusta para el PhD**
...
1. Enviar correctamente todos los documentos solicitados
    ...
    + Writing Sample: Algun documento de investigación propio o coautoreado, mejor si está en inglés
